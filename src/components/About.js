  ...
  render() {
    return (
      <div className="home-main">
        <div className="home-head">About Me</div>

        <div className="home">
          <div className="home-img">
            <img id="home-image" src={backi} alt="background" />
          </div>
          <div className="home-text">
            <div>
              I have been curious about new technologies since childhood,
              with a particular interest in RPA, web applications, digital marketing,
              and data science. My journey began with a Bachelor of Technology in Information Technology from
